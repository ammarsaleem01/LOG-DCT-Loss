classdef DCTRegressionLayer < nnet.layer.RegressionLayer
    % Example custom regression layer with mean-absolute-error loss.
    
    methods
        function layer = DCTRegressionLayer(name)
        ...
        function loss = forwardLoss(~, Y, T)
            ...
            for ii = oneG:R4
                for jj = oneG:R3
                    ...
                    sloss_ii_jj = sum((dctY-dctT).^2,[1,2])/(R1*R2);
